...
var youtube_dl_exec_1 = require("@devsnowflake/youtube-dl-exec");
...
var Track = /** @class */ (function () {
    ...
    Track.prototype.createAudioResource = function () {
        ...
        return new Promise(function (resolve, reject) {
            var process = youtube_dl_exec_1.raw(_this.url, {
                o: '-',
                q: '',
            ...
            process
                ...
                voice_1.demuxProbe(stream)
                    .then(function (probe) { return resolve(voice_1.createAudioResource(probe.stream, { metadata: _this, inputType: probe.type })); })["catch"](onError);
            })["catch"](onError);
        });
    };
    /**
    ...
    Track.from = function (url, methods) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ytdl_core_1.getInfo(url)];
                    case 1:
                        info = _a.sent();
                        wrappedMethods = {
                            onStart: function () {
